...
<p class="mb-4"><?php echo $branch; ?> Daily Sales Report.</p>
    <!-- <h1 class="h3 mb-0 text-gray-800"></h1>
            <a href="<?php echo URL('create_sales_report'); ?>"  class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<!-- SHOWS PRODUCTS RESULTS -->
  ...
  <tbody>
    ...
    <tr>
      ...
      <td 
      <?php
      if ($value->category == 'refill') {?>
      class="bg-success text-light"
      <?php } else{?>
      class="bg-info text-light"
      <?php } ?>>
      <?php echo ucfirst($value->category); ?></td>
      ...
      <td>
      <a href="<?php echo URL('view_sales&value='.$_SESSION['admin']->station.'&tbl=sales&action=delete&id='.$value->id); ?>"  class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
