...
<head>
    ...
    <title>Mount Meru - Superuser Access Control</title>
...
<img src="assets/img/2.png" alt="...">
				...
				<h3 style="background-color:#4a5772a6; color:#fff; padding:10px; 
				    ...
				    id="tnk">Welcome to Mount Meru Group superuser account.</h3>
        ...
        <?php echo $data['password'] ?? '';?></span>
			...
			<div style="display:flex; justify-content:center;">
				<p><a style="text-decoration:none; font-size:smaller; color:#1d2129;" href="#">Lilongwe Branches System Monitor.</p>
			</div>
		</div>
	</div>
</div>
